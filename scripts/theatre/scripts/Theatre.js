...
export class Theatre {
    ...
    // static SOCKET = "module.whiston-FVTT-private-module";
    // static SETTINGS = "theatre";
    // static NARRATOR = "Narrator";
    // static ICONLIB = "modules/whiston-FVTT-private-module/assets/graphics/emotes";
    ...
    initialize() {
        if (this.initialized || document.getElementById("theatre-group")) {
            this.initialized = true;
            return;
        }
        // inject HTML
        this._injectHTML();
        if (!document.getElementById("theatre-group")) return;
        this.initialized = true;
        // socket
        this._initSocket();
        // global listeners
    ...
    async _createPortraitPIXIContainer(imgPath, portName, imgId, optAlign, emotions, isLeft) {
        ...
        imgSrcs.push({
            imgpath: "modules/whiston-FVTT-private-module/assets/graphics/typing.png",
            resname: "modules/whiston-FVTT-private-module/assets/graphics/typing.png",
        });
    ...
    async _setupPortraitContainer(imgId, optAlign, resName, resources, reorder) {
        ...
        if (!insert.typingBubble) {
            ...
            typingBubble.texture = resources["modules/whiston-FVTT-private-module/assets/graphics/typing.png"];
